...
SS <- read.csv(file="~/Desktop/bruna_scripts/ExpressionPipeline2/ExpressionFullSampleSheet.csv", header=TRUE)


# Plot and summarize the signal-to-noise ratio for the arrays
setwd("~/Desktop/bruna_scripts/ExpressionPipeline2/ScannerMetrics")

pdf("~/Desktop/BreastPDTX/data/results/normalize_RNA_expression/SignaltoNoise.pdf",
    width=12, height=8)
...
write.csv(quality.arrays, file="~/Desktop/BreastPDTX/data/results/normalize_RNA_expression/high_quality_arrays.csv", row.names=FALSE)
...
write.csv(sampleSheetFile, file="~/Desktop/BreastPDTX/data/results/normalize_RNA_expression/sampleSheet.csv", row.names=FALSE)
...
write.csv(QC_compare, file="~/Desktop/BreastPDTX/data/results/normalize_RNA_expression/QC_compare.csv", row.names=FALSE)